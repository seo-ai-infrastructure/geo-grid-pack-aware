-- Geo-Grid v2 (idempotent: safe whether or not v1 was already run) — paste into the ledger project's SQL Editor.
-- Adds Chrome pack capture columns; includes the full v1 schema as create-if-not-exists.
